    ...
    SecurityFilterChain securityFilterCahin(HttpSecurity httpSecurity) throws Exception {
		...
		return httpSecurity
				...
				.authorizeHttpRequests(authorize -> authorize
						.requestMatchers(HttpMethod.POST, "api/cardapio/auth/**").permitAll()
						.requestMatchers("\"/swagger-ui/**\", \"/v3/api-docs/**\", \"/swagger-resources/**\"").permitAll()
						.requestMatchers(HttpMethod.POST, "api/cardapio/**").hasRole("ADMIN")
						.requestMatchers(HttpMethod.PUT, "api/cardapio/**").hasRole("ADMIN")
						.requestMatchers(HttpMethod.DELETE, "api/cardapio/**").hasRole("ADMIN")
